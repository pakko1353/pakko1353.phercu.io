...
function setupPortfolioSection() {
    ...
    $('.tm-view-more').click(function(){
        if($(this).text().toLowerCase() == "ver más") {
            $(this).text("Ver Menos");
            $('.tm-show-hide').show();
        }
        else {
...
function loadGoogleMap(){
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBTCb6ae_VYtnAIYe-p8SseSZqcm7JhPwI&v=3.exp&' + 'callback=initialize';
